...
$mod_strings = array(
    'LBL_CAPTCHA_HELP_TEXT' => 'CAPTCHA Это тест с запросом к отправителю, с целью убедиться, что ответ не был сгенерирован компьютером автоматически. Для работы этой опции необходимо получить открытый и закрытый ключи с сайта reCAPTCHA: http://recaptcha.net/ .',
    'CAPTCHA' => 'CAPTCHA',
    ...
    'LBL_CONFIG_FTS' => 'Настройка полнотекстового поиска',
    ...
    'LBL_CONFIG_TABS_DESC' => 'Перетащите имена модулей, чтобы отобразить или скрыть в верхней навигационной панели или субпанелях. Чтобы управлять доступом к модулям, используйте <a href="?module=ACLRoles&action=index">Управление ролями.</a>',
...
Последняя попытка подключения @ ',
    ...
    'LBL_EDIT_TABS' => 'Удалить страницу',
    ...
    'LBL_EXPORT_DOWNLOAD_KEY' => 'Экспорт ключа загрузки',
    ...
    'LBL_FTS_SETTINGS' => 'Полнотекстовый поиск',
    'LBL_FTS_SETTINGS_DESC' => 'Настройка системы полнотекстового поиска.',
    ...
    'LBL_LICENSE_EXPIRE_DATE' => 'Дата окончания',
    'LBL_LICENSE_KEY' => 'Ключ активации',
    'LBL_LICENSE_NUM_LIC_OC' => 'Количество лицензий на рабочие места',
    ...
    'LBL_LICENSE_UNAUTHORIZED_ACCESS' => 'Несанкционированный доступ к настройкам лицензии.',
    ...
    'LBL_LIST_SYSTEM_NAME' => 'Название системы',
    'LBL_LIST_VIEW' => 'Список',
    'LBL_LIST_SYMBOL' => 'Категория',
    'LBL_LIST_RATE' => 'Значение',
...
//END SUGARCRM flav=een
    ...
    'LBL_REBUILD_WORKFLOW_COMPILING' => 'Компиляция плагинов... <BR>',
    ...
    'LBL_REPAIR_INDEX_ALTERING' => '<BR>Добавить ограничения/индексы.',
    ...
    'LBL_REPAIR_ORACLE_COMMIT' => 'Вперёд',
    ...
    'LBL_SAML_LOGIN_URL' => 'SAML URL', //SAML Authentication
    ...
    'LBL_SNIP_TITLE' => 'Архивирование почты',
    'LBL_SNIP_DESC' => 'Configure offline archiving (Email Archiving)',
    'LBL_CONFIGURE_SNIP' => 'Архивирование почты',
    'LBL_CONFIGURE_SNIP_DESC' => 'Включение/отключение службы архивирования электронной почты SuiteCRM',
    ...
    'LBL_AVAILABLE_FTS_MODULES' => 'Выберите модули для индексирования.',
    ...
    'LBL_CONNECT_STATUS' => 'Состояние подключения',
    'LBL_FTS_SETTINGS_TITLE' => 'Параметры полнотекстового поиска',
    'LBL_FTS_TEST' => 'Тестовый',
    ...
    'LBL_FTS_ADVANCED_LINK' => 'Включение модулей',
    'LBL_FTS_ADVANCED_LINK_HELP' => 'Выберите модули в которых пользователи смогут выполнять полнотекстовый поиск.',
...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
    ...
    'LBL_JJWG_MAPS_ADMIN_DONATE_TITLE' => 'Помочь проекту',
    'LBL_JJWG_MAPS_ADMIN_DONATE_DESC' => ' ',
    'LBL_JJWG_MAPS_ADMIN_GEOCODE_ADDRESSES_TITLE' => 'Геокодировать адреса',
    ...
    'LBL_JJWG_MAPS_ADMIN_GEOCODING_TEST_TITLE' => 'Тест геокодирования',
    ...
    'LBL_COLOUR_ADMIN_MENUFONT' => 'Цвет надписей закладок: ',
    'LBL_COLOUR_ADMIN_MENULNKHVR' => 'Цвет надпией закладок при наведении курсора: ',
    'LBL_COLOUR_ADMIN_BTNTOP' => 'Цвет кнопок: ',
    'LBL_COLOUR_ADMIN_BTNHOVER' => 'Цвет кнопок при наведении курсора: ',
    'LBL_COLOUR_ADMIN_BTNLNK' => 'Цвет надписей кнопок: ',
    'LBL_COLOUR_ADMIN_BTNLNKHOVER' => 'Цвет надписей кнопок при наведении курсора: ',
    'LBL_COLOUR_ADMIN_DASHHEAD' => 'Цвет заголовков дашлетов: ',
    ...
    'LBL_AOP_JOOMLA_URL' => 'URL-адрес Joomla',
    ...
    'LBL_AOP_EMAIL_SETTINGS' => 'Настройка E-mail',
    ...
    'LBL_AOP_OPENING_HOURS' => 'Рабочее время',
    'LBL_AOP_CLOSING_HOURS' => 'Нерабочее время',
    ...
    'LBL_AOS_ADMIN_CONTRACT_RENEWAL_REMINDER' => 'Период действия договора',
    ...
    'LBL_SECURITYGROUPS_UPGRADE_INFO_TITLE' => "Обновление и общая информация",
    'LBL_SECURITYGROUPS_INFO_TITLE' => "Информация о модуле безопасности",
    'LBL_SECURITYGROUPS_INFO' => "Общая информация",
    'LBL_SECURITYGROUPS_DASHLETPUSH_TITLE' => "Dashlet push-сообщение",
    'LBL_SECURITYGROUPS_DASHLETPUSH' => "Разослать dashlet-сообщение на домашние страницы всех пользователей. Этот процесс может занять некоторое время в зависимости от числа пользователей",
    'LBL_SECURITYGROUPS_HOOKUP_TITLE' => "Модуль связи",
    'LBL_SECURITYGROUPS_HOOKUP' => "Модуль безопасности связи для работы с вашими модулями",
    ...
    'LBL_USER_LOCKOUT' => 'Блокировка пользователя',
    ...
    'LBL_AUTO_UNLOCK_TIME_UNITS' => 'минут',
