...
$mod_strings = array (
    ...
    'LBL_RELATED_ACCOUNTS' => 'Не создавайте связаных учетных записей ',
    ...
    'LBL_EXT_SOURCE_SIGN_OUT' => 'Выйти из системы',
    ...
    'LBL_SIGN_IN_HELP' => 'Для включения этого сервиса, пожалуйста подпишитесь под вкладкой Внешнее Учетные записи, на странице пользовательских настроек'
);
