...
'LBL_LISTVIEWP_DESCRIPTION'=>'Перед вами две колонки: в первой расположены отображаемые поля, во второй - поля, доступные для отображения. Вы можете перемещать поля между колонками. Вы также можете изменять порядок расположения полей внутри каждой колонки путём их перемещения.',
