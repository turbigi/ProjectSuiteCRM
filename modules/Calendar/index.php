...
$views = array("agendaDay" => array(), "basicDay" => array(), "basicWeek" => array(), "agendaWeek" => array(), "month" => array(), "sharedMonth" => array(), "sharedWeek" => array(), "sharedWeekAll" => array(), "sharedMonthAll" => array());
...
if ($cal->view == "sharedMonth" || $cal->view == "sharedWeek" || $cal->view == "sharedMonthAll" || $cal->view == "sharedWeekAll") {
    $cal->init_shared();
    global $shared_user;
...
if ($cal->view == "sharedMonth" || $cal->view == "sharedWeek" || $cal->view == "sharedWeekAll" || $cal->view == "sharedMonthAll") {
