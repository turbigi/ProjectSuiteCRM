...
$mod_strings = array (
    ...
    'LBL_DISPLAYED_URL' => 'Отображаемый URL',
    ...
    'LBL_EXTNOT_HEADER' => 'Ошибка: Вы не приглашены на встречу', // You are not invited to the meeting messages
  ...
  //For export labels
    ...
    'LBL_EMPTY_SEARCH_RESULT' => 'По указанным критериям ничего не обнаружено. Вы можете создать приглашение "с нуля", добавив в него новые контакты / предварительные контакты.',  // create invitee functionallity
